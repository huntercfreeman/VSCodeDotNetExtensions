...
export class MessageCreateProjectInSolutionFolder extends MessageBase implements IMessageCreate {
    /**
     *
     */
    ...
    public readonly messageCreateKind: MessageCreateKind = MessageCreateKind.projectInSolutionFolder;
}